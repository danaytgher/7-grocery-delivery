...
export default function AdminProducts() {
  ...
  const handleMarkOutOfStock = async (id: string, name: string) => { const confirmed = window.confirm( `Are you sure you want to mark "${name}" as out of stock?` ); if (!confirmed) return; try 
  { await api.delete(`/products/${id}`); 
  toast.success("Product marked as out of stock"); 
  fetchProducts(); } catch (error: any) { console.error("Mark out of stock error:", error); 
